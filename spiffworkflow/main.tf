locals {
  ...
  backend_url   = var.base_url_override != "" ? "${var.base_url_override}/api" : "https://${module.backend_route.endpoint}"
  connector_url = "https://${module.connector_route.endpoint}:61443"
  frontend_url  = var.base_url_override != "" ? var.base_url_override : "https://${module.frontend_route.endpoint}"
